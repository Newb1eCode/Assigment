...
import com.example.demosd18307.repos.MauSac_Repository;
import com.example.demosd18307.repos.SanPham_Repository;
import com.example.demosd18307.repos.Size_Respository;
...
public class CtspServlet extends HttpServlet {
    ...
    private Size_Respository szRes = new Size_Respository();
    @Override
    ...
    private void update(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ct.setNgayTao(res.getdetail(id).getNgayTao());
